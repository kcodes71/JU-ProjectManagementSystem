...
<div class="page-head">
    ...
    <div>
        ...
        <div class="page-sub">
            {{ $scoped ? "Your teams' status" : "Directorate-wide status" }}
            across
...
>
    ...
    <div class="card stat-card">
        ...
        <div class="stat-delta">
            {{ $scoped ? "Across your team(s)" : "Across all teams" }}
        </div>
    ...
    <div class="card stat-card">
        ...
        <div class="stat-delta">
            ETB
            {{ number_format($stats['budget_spent']) }}
            of
            {{ number_format($stats['budget_allocated']) }}
        </div>
    ...
    <div class="card card-pad">
        ...
        @if ($projects->isEmpty())
            ...
            <div class="empty">
                ...
                {{ $scoped
                    ? "Nothing assigned to your team so far."
                    : ""
                }}
        ...
        <table>
            ...
            <tbody>
                ...
                @foreach ($projects as $p)
                    ...
                    <tr
                        onclick="window.location='{{ route('projects.show', $p) }}'"
                    >
